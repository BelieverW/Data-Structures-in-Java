...
public class Homework6Test {
  ...
  public static void main(String[] args) {
    ...
    exCollisions = numBoards - table.capacity() + table.capacity() * Math.pow((1 - 1.0 / table.capacity()), numBoards); 
    
    System.out.println("Number of entries: " + numBoards);
    System.out.println("Number of buckets: " + table.capacity());
    System.out.println("Expected number of collisions: " + exCollisions);
